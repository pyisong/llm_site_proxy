...
SAMPLE_CURL = """curl 'https://chat.stepfun.com/chats/new' \\
  -H 'accept: text/html' \\
  -b 'HWWAFSESTIME=1782456997014; HWWAFSESID=ebb9111e6c8eac72242; stepfun_session=bb904ad3aac74dfa96f6d344c90a6f4b' \\
...
def test_extract_cookie_header_from_curl():
    ...
    assert "stepfun_session=bb904ad3aac74dfa96f6d344c90a6f4b" in header
...
def test_parse_curl_cookies():
    ...
    assert cookies[-1]["name"] == "stepfun_session"
    assert cookies[-1]["domain"] == ".stepfun.com"
    assert ua is not None
