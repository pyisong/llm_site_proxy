"""检查 deepseek_storage.json 是否包含完整登录信息。"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="校验 DeepSeek storage state 文件")
    parser.add_argument(
        "path",
        nargs="?",
        default=os.getenv("DEEPSEEK_STORAGE_STATE_FILE", "secrets/deepseek_storage.json"),
    )
