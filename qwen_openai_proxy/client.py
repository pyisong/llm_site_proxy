...
def preflight() -> None:
    ...
    if response.status_code == 404:
        print(
            "Port 8000 is not running the current deepseek_openai_proxy app.\n"
            "Stop the old process, then restart with:\n\n"
            "  cd /Users/zhujianwei/projects/workspace/deepseek_openai_proxy\n"
            "  export DEEPSEEK_BACKEND=browser\n"
            "  export DEEPSEEK_PROXY_API_KEY=local-secret\n"
            "  export DEEPSEEK_BROWSER_PROFILE=/Users/zhujianwei/.deepseek-browser-profile\n"
