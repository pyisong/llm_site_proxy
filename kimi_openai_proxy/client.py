...
def preflight() -> None:
    ...
    if response.status_code == 404:
        print(
            "Port 8000 is not running the current kimi_openai_proxy app.\n"
            "Stop the old process, then restart with:\n\n"
            "  cd /Users/zhujianwei/projects/workspace/kimi_openai_proxy\n"
            "  export KIMI_BACKEND=browser\n"
            "  export KIMI_PROXY_API_KEY=local-secret\n"
            "  export KIMI_BROWSER_PROFILE=/Users/zhujianwei/.kimi-browser-profile\n"
