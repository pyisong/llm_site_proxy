...
SAMPLE_CURL = """curl 'https://www.kimi.com/' \\
  -H 'accept: text/html' \\
  -b 'HWWAFSESTIME=1782456997014; HWWAFSESID=ebb9111e6c8eac72242; kimi_session=bb904ad3aac74dfa96f6d344c90a6f4b' \\
...
def test_extract_cookie_header_from_curl():
    ...
    assert "kimi_session=bb904ad3aac74dfa96f6d344c90a6f4b" in header
...
def test_parse_curl_cookies():
    ...
    assert cookies[-1]["name"] == "kimi_session"
    assert cookies[-1]["domain"] == ".kimi.com"
    assert ua is not None
